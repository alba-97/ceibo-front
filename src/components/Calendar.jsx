      ...
      <View style={styles.calendarContainer}>
        ...
        <View style={styles.datesContainer}>
          {Array(firstDayIndex)
            .fill('')
            .map((_, index) => (
              <TouchableOpacity key={`empty-${index}`} style={styles.dateCell} disabled={true}>
          ...
          {calendarData.map(({ date, events }) => (
            <TouchableOpacity
              ...
              style={[
                ...
                date.toISOString().split('T')[0] === selectedDate && styles.selectedDateCell,
              ]}
        ...
        return (
          <View style={styles.eventPreviewsContainer}>
            ...
            {selectedEvents.map((event, index) => (
              <Text key={index} style={styles.eventPreviewText}>{event.name}</Text>
            ))}
          </View>
        );
      }
